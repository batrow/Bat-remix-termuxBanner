...
echo " "
bash ashi.sh
echo -e "\e[31m[\e[32m*\e[31m]\e[33mRemoving Bat-Remix \e[m "
sleep 2
...
tput cup 6 30
echo -e "\x1b[42m by SITHUM BATROW \x1b[m"
tput cup 9 0
...
tput cup 15 0
echo -en "\e[93m its good (y/n)? \e[m "
read answer
...
tput cup 17 23
    echo -e "\x1b[41m its ok \x1b[m"
fi
tput cup 20 0
figlet -f slant "by SITHUM BATROW" |lolcat
echo " "
echo " "
