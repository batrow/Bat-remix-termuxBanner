...
######################################
#        PROJECT: bat-Remix            #
#        Author: SITHUM BATROW       #
#  email: batro10300@gmail.com   #
######################################
echo -e "\e[32m[*]\e[34m WELCOME TO SI BATROW TOOLS  \e[m "
echo
#Installing the following packages to install Bat-Remix
echo " "
echo -e "\e[32m[*]\e[34m Installing Bat-Remix \e[m "
echo
#storage permission
termux-setup-storage -y && rm -rf Bat-Remix-master
...
echo "
        ...
        WELCOME TO SI BATROW TOOLS_-^^TECH KNOW LINUX^^-_ 
...
echo " "
echo "[*]Installing Bat-Remix please wait " |lolcat
sleep 3
...
echo -e "\033[1;33m[*]system ok -- CHECKED BY SITHUM BATROW\e[m "
...
HI I am SITHUM batrow my gmail is batrow10300@gmail.com   
        My whatsapp number is -. 0710572234
...
tput clear
tput cup 3 30
echo -e "\e[44m Like \e[41m thanks \e[m"
tput cup 6 30
echo -e "\x1b[42m are you lacky for using my tool \x1b[m"
tput cup 9 0
...
tput cup 15 0
echo -en "\e[93m I'am SITHUM BATROW is it good  (y/n)? \e[m "
read answer

if [ "$answer" != "${answer#[Yy]}" ] ;then
tput cup 17 21
    echo -e "\e[42m Thankyou for you \e[m"
else
tput cup 17 23
    echo -e "\x1b[41m it's okay \x1b[m"
fi
tput cup 20 0
figlet -f slant "SITHUM BATROW's TECH KNOW LINUX" |lolcat
echo " "
echo " "
#done setting up
